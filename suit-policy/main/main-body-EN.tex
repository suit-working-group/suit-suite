...
the institutional actors concerned (central executive leadership, faculties,
...
institution's academic governing bodies (the collegial academic councils and
...
\begin{stakeholderbox}[Message to \loc{governing-board} and executive leadership]{blue}
...
governing bodies (the collegial academic councils and \loc{governing-board}) for
...
concerned components (the central executive leadership, faculties, interdisciplinary
...
\begin{enumerate}[nosep]
    ...
    governing bodies (the collegial academic councils and
    ...
    \item If endorsed by \loc{governing-board}, the central
...
non-specialist decision-makers, particularly members of the
institution's collegial academic councils and
...
\begin{description}[nosep]
    ...
    institution \emph{may} be classified as an \emph{essential entity},
    depending on the national transposition --- the public-administration
...
\begin{description}[nosep]
    \item[Status.] Depending on the national transposition, a public
    research-and-teaching institution may be classified as an
    \emph{essential entity}; in the worked transposition example, the
...
\begin{itemize}[nosep]
    \item \textbf{For decision-makers (the collegial academic
    councils and \loc{governing-board}):}
...
information-security policy and \loc{national-cyber-strategy}'s
...
Directive~\cite{nis2}, a public research-and-teaching institution is
may be classified --- depending on the national transposition, on
written confirmation by the national competent authority (the NIS2
supervisory authority) --- as an \keyword{essential entity}, the
public-administration entry of NIS2 Annex~I being the basis in the
worked example. This classification is
...
\begin{description}[nosep]
    ...
    \loc{national-gov-csirt}. As a public
...
disambiguation: a separate CSIRT serving the private sector, communes
and non-governmental entities (relevant when third-party private
partners are involved), and a financial-sector supervisor (competent
...
\Loc{cer-national-transposition}, transposing the Critical Entities
...
essential under NIS2. A given institution may or may not be designated
as a CER critical entity; the cross-reference is provided for
...
by \loc{national-public-sector-isp}, developed
by \loc{national-infosec-agency} and applicable to State
...
authority and \loc{national-spoc-authority} as part of the
...
and \keyword{isolation of activity contexts} as defences, not to blanket restriction.
...
\begin{itemize}[nosep]
    ...
    Many universities were affected (e.g.\ UCLA and the University
    System of Georgia, among many others). \textbf{These breaches were caused by a \emph{third-party
...
In many national ecosystems the public documentation of the NREN and
of the institution's HPC facility does not, as of early 2026, evidence
a deployed \gls{sciencedmz} at the institution or at the national
...
connectivity through the national NREN, the NREN's CSIRT for
incident response, and an institutional HPC facility with
...
\begin{itemize}[nosep]
    ...
    research ecosystem is small (the institution together with a
    handful of national research institutes), it may be too small for
...
Several universities --- in the United Kingdom, the Netherlands,
Germany, Australia and Japan among others --- have obtained
certification, typically for specific scopes.
...
For the adopting institution, such a method carries a specific
...
Policy Commission (Section~\ref{sec:dpc}), the collegial academic
councils, the responsibility charters and the ICRADP
...
\begin{itemize}[nosep]
    ...
    proposals that are submitted to the institution's collegial
    academic councils for endorsement before implementation.
\end{itemize}
...
\smallskip\noindent
Applied to a research-and-teaching university --- typically organised
into faculties, each with departments of teaching and research, and
interdisciplinary centres with strong industrial and institutional
...
institutional decision path: endorsement by the relevant collegial
academic councils before operational
...
\begin{enumerate}[nosep]
    ...
    endorsement by the relevant collegial academic council for
...
within the institution's multi-year planning and funding cycle,
...
\begin{enumerate}
    ...
    \gls{eduroam} and the national NREN-operated identity
    federation (linked to eduGAIN), enabling inter-institutional
...
\begin{itemize}
    ...
    \item \textbf{\loc{national-equal-treatment-law}}
...
Many institutions already operate a
\keyword{reasonable-adjustments committee} (or equivalent) that supports
...
\begin{enumerate}
    \item \textbf{Independence:} the commission reports to the central
    executive leadership
    ...
    to the central executive leadership in case of refusal.
